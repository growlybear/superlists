...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # "1: Buy peacock feathers" as an item in a topdo list
        ...
        self.assertTrue(
            ...
            "New to-do item did not appear in the to-do items table"
        )

        # There is still a text ox inviting her to add another item.
